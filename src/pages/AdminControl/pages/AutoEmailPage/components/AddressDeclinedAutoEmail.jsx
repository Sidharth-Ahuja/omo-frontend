...
const AddressDeclinedAutoEmail = () => {
  ...
  const fetchEmailTemplate = async () => {
    try {
      const docRef = await doc(fireStore, 'auto-email-templates', 'addressDeclined')
  ...
  const handleImageUpload = async (event, field) => {
    ...
    if (file) {
      ...
      const storagePath = `auto-email-templates-images/addressDeclined/${field}`
      ...
      >
        <div className='max-w-3xl mx-auto p-8 rounded-lg shadow-lg'>
          ...
          <div className='text-white mt-10'>
            ...
            <p className='text-lg'>
              <span className='text-[#FCC100] font-semibold'>Incomplete Information: </span>
              {isEditing ? (
                <textarea
                  value={formData.IncompleteInformationText}
                  onChange={(e) =>
                    setFormData({
                      ...formData,
                      IncompleteInformationText: e.target.value,
                    })
                  }
                ...
                <span className='font-light'>
                  {emailData.IncompleteInformationText}
                </span>
              )}
            </p>
            ...
            <p className='text-lg'>
              ...
              {isEditing ? (
                <textarea
                  value={formData.DocumentQualityText}
                  onChange={(e) =>
                    setFormData({
                      ...formData,
                      DocumentQualityText: e.target.value,
                    })
                  }
                  className='text-white bg-transparent border p-2 w-full font-light'
                />
            ...
            <p className='text-lg mb-10'>
              ...
              {isEditing ? (
                <textarea
                  value={formData.OudatedText}
                  onChange={(e) =>
                    setFormData({
                      ...formData,
                      OudatedText: e.target.value,
                    })
                  }
                  className='text-white bg-transparent border p-2 w-full font-light'
                />
              ) : (
                <span className='font-light'>{emailData.OudatedText}</span>
              )}
            </p>
            <p className='text-[#FCC100] font-semibold text-lg mb-4'>
            What's Next?
            ...
            <p className='text-lg'>
              <span className='text-[#FCC100] font-semibold'>Resubmit Documents: </span>
              {isEditing ? (
                <textarea
                  value={formData.ResubmitDocumentsText}
                  onChange={(e) =>
                    setFormData({
                      ...formData,
                      ResubmitDocumentsText: e.target.value,
                    })
                  }
                  className='text-white bg-transparent border p-2 w-full font-light'
                />
                ...
                <span className='font-light'>
                  {emailData.ResubmitDocumentsText}
                </span>
              )}
            </p>
            ...
            <p className='text-lg'>
              ...
              {isEditing ? (
                <textarea
                  value={formData.AssistanceText}
                  onChange={(e) =>
                    setFormData({
                      ...formData,
                      AssistanceText: e.target.value,
                    })
                  }
                  className='text-white bg-transparent border p-2 w-full font-light'
                />
...
export default AddressDeclinedAutoEmail
