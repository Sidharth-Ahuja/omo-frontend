...
const IDDeclinedAutoEmail = () => {
  ...
  const fetchEmailTemplate = async () => {
    try {
      const docRef = await doc(fireStore, 'auto-email-templates', 'idDeclined')
  ...
  const handleImageUpload = async (event, field) => {
    ...
    if (file) {
      ...
      const storagePath = `auto-email-templates-images/idDeclined/${field}`
...
export default IDDeclinedAutoEmail
