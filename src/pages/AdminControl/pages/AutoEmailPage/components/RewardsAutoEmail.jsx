...
const RewardsAutoEmail = () => {
  ...
  const fetchEmailTemplate = async () => {
    try {
      const docRef = await doc(fireStore, 'auto-email-templates', 'rewards')
  ...
  const handleImageUpload = async (event, field) => {
    ...
    if (file) {
      ...
      const storagePath = `auto-email-templates-images/rewards/${field}`
      ...
      >
        <div className='max-w-3xl mx-auto p-8 rounded-lg shadow-lg'>
          ...
          <div className='text-white mt-10'>
            ...
            <p className='text-lg'>
              <span className='text-[#FCC100] font-semibold'>Reward: </span>
              {isEditing ? (
                <textarea
            ...
            <p className='text-lg'>
              ...
              {isEditing ? (
                <textarea
                  value={formData.UnlockedOnText}
                  onChange={(e) =>
                    setFormData({
                      ...formData,
                      UnlockedOnText: e.target.value,
                    })
                  }
                  className='text-white bg-transparent border p-2 w-full font-light'
                />
              ...
              {isEditing ? (
                <textarea
                  ...
                  onChange={(e) =>
                    setFormData({
                      ...formData,
                      HowToUseText: e.target.value,
                    })
                  }
                  className='text-white bg-transparent border p-2 w-full font-light'
                />
              ) : (
                <span className='font-light'>{emailData.HowToUseText}</span>
              )}
            </p>
...
export default RewardsAutoEmail
