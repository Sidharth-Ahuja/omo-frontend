...
const Template1 = () => {
  ...
  const handleImageUpload = async (event, field) => {
    ...
    if (file) {
      ...
      const storagePath = `auto-email-templates-images/addNewTemplate1/${field}`
  ...
  return (
    <div>
        ...
        <div className='max-w-3xl mx-auto p-8 rounded-lg shadow-lg'>
          <div className='text-center mb-8'>
            ...
            {isEditing ? (
              ...
              <h4 className='text-white text-lg font-normal border-[1px] border-[#FCC100] mt-6 mx-16 py-1'>
      ...
      <div className='text-center my-4 flex justify-center gap-8'>
        <button
          onClick={() => {
        ...
        {!isEditing && (
          <button
            ...
            className='bg-[#4CAF50] text-white py-2 px-8 rounded hover:bg-[#388E3C]'
          >
            {'Send'}
          </button>
        )}
