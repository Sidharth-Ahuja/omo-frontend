...
const WithdrawReqPage = () => {
  ...
  console.log(adminAuthID, "adminAuth Id is here");
  const color = "blue";
  ...
  console.log(openDateTab, "here is the date variable");
      ...
      for (const userDoc of usersQuerySnapshot.docs) {
        ...
        querySnapshot.forEach((doc) => {
          ...
          switch (time) {
            ...
            case "LastMonth":
              const lastWeekStart1 = moment()
                .subtract(1, "month")
                .startOf("month");
              const lastWeekEnd1 = new Date();

              if (docDate.isBetween(lastWeekStart1, lastWeekEnd1, null, "[]")) {
                userData = { userId:userId, user: userDoc.data(), invoice: doc.data() };
                allDocuments.push(userData);
              }
              break;
          ...
          console.log("allDocuments TIME", allDocuments, time)
        });
      }
  ...
  return adminAuthID ? (
    <div className="p-4 sm:ml-64 bg-[#FAFAFA]">
      <h2 className="flex items-center gap-1 text-[1.4rem] font-[700] pb-2">
        Withdraw <PaidSharpIcon sx={{ color: "goldenrod", height: "100%" }} />{" "}
      </h2>

      {/* search box and date filter option  */}
        ...
        >
          ...
          <li className="-mb-px cursor-pointer mr-2 last:mr-0 flex-auto text-center">
            <a
              ...
              onClick={(e) => {
                e.preventDefault();
                setOpenDateTab("ThisMonth");
                fetchWithDrawalsForDate("ThisMonth");
              }}
              data-toggle="tab"
              // href='#link3'
              role="tablist"
